...
<head>
    ...
    <link rel="icon" type="image/png" href="<?= base_url('assets/img/profile/'); ?>pro1564635980.png">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <?php } ?>
                    <span class="nav-item nav-link nav-right" style="display:block; margin-left:20px;">Selamat Datang <b><?= $user; ?></b></span> </div>
            </div>
        </div>
    </nav>
